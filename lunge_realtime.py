...
class UniversalTTS(QObject if QT_AVAILABLE else object):
    ...
    def __init__(self):
        ...
        self.feedback_messages = {
            "좌우 흔들림": "코어에 힘을 주고 몸의 균형을 잡으세요.",
            "무릎 모임": "무릎이 발끝 방향을 보도록 하세요.",
            "과도한 무릎 전진": "무릎이 발끝을 넘어가지 않게 하세요.",
            "상체 숙여짐": "상체가 앞으로 숙여져 있어요. 가슴을 펴고 일어나세요.",
            "부족한 깊이": "더 깊게 내려가세요.",
            "좁은 스탠스": "발을 어깨너비만큼 벌리세요.",
            "앞발목 가동성 부족": "앞발목을 더 굽혀보세요."
        }
